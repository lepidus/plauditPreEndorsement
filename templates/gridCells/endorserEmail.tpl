...
<span {if $cellId}id="{$cellId|escape}" {/if}class="pkpBadge" title="{translate key="plugins.generic.plauditPreEndorsement.endorserEmailCount.many" numEmails=$emailCount}">
	{$emailCount}
</span>
