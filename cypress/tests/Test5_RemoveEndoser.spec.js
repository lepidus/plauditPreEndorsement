...
describe("Plaudit Pre-Endorsement Plugin - Check remove endorser button", function() {
    ...
    it("Removes endorsement in submission workflow", function() {
        cy.contains("Review this submission").click();
        cy.get("#publication-button").click();
        cy.contains("Pre-Endorsement").click();
        
        cy.get("#plauditPreEndorsement").contains("Remove endorsement").click();
        cy.on('window:confirm', (str) => {
            expect(str).to.equal("Do you want to remove the endorsement of this submission?");
        });
