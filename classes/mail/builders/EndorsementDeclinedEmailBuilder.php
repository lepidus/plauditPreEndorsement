...
use APP\plugins\generic\plauditPreEndorsement\classes\mail\mailables\EndorsementDeclined;

class EndorsementDeclinedEmailBuilder implements EmailBuilder
{
    private $endorsement;
    private $publication;
    ...
    public function build(array $args = []): Mailable
    {
        ...
        $email = new EndorsementDeclined($context, $submission, $this->emailParams);
